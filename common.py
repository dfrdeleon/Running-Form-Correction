...
CocoPairs = [
    (1, 2), # Neck -> RShoulder: Right Clavicle
    (1, 5), # Neck -> LShoulder: Left Clavicle
    (2, 3), # RShoulder -> RElbow: Right Humerus
    (3, 4), # RElbow -> RWrist: Right Forearm
    (5, 6), # LShoulder -> LElbow: Left Humerus
    (6, 7), # LElbow -> Lwrist: Left Forearm
    (1, 8), # Neck -> RHip: Right Torso
    (8, 9), # RHip -> RKnee: Right Femur
    (9, 10), # RKnee -> RAnkle: Right Shin
    (1, 11), # Neck -> LHip: Left Torso
    (11, 12), # LHip -> LKnee: Left Femur
    (12, 13), # LKnee -> LAnkle: Left Shin
    (1, 0), # Neck -> Nose
    (0, 14), # Nose -> REye
    (14, 16), # REye -> REar
    (0, 15), # Nose -> LEye
